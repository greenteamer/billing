...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'main_order', 'city')

        # Deleting field 'Order.phone'
        db.delete_column(u'main_order', 'phone')

        # Deleting field 'Order.email'
        db.delete_column(u'main_order', 'email')


    def backwards(self, orm):
        # Adding field 'Order.city'
        db.add_column(u'main_order', 'city',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=50),
                      keep_default=False)

        # Adding field 'Order.phone'
        db.add_column(u'main_order', 'phone',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=20),
                      keep_default=False)

        # Adding field 'Order.email'
        db.add_column(u'main_order', 'email',
                      self.gf('django.db.models.fields.EmailField')(default=1, max_length=50),
                      keep_default=False)
