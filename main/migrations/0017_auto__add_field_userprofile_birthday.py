...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'main_userprofile', 'birthday',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 2, 5, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.birthday'
        db.delete_column(u'main_userprofile', 'birthday')
