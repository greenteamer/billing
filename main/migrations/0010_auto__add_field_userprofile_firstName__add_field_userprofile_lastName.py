...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'main_userprofile', 'firstName')

        # Deleting field 'UserProfile.lastName'
        db.delete_column(u'main_userprofile', 'lastName')
